...
import kotlinx.android.synthetic.main.item_match_vertical.view.*

class MatchVerticalAdapter(private val matchList: MutableList<MatchEntity>,
                           private val listener: (MatchEntity) -> Unit
) : RecyclerView.Adapter<MatchVerticalAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val view = layoutInflater.inflate( R.layout.item_match_vertical, parent, false )
