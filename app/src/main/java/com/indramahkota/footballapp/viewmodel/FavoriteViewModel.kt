...
class FavoriteViewModel @Inject constructor(private val repository: FootballAppRepository) :
    ...
    var favoriteMatchById: LiveData<MatchEntity> =
        Transformations.switchMap(favoriteMatchId) { id: String ->
    ...
    var favoriteTeamById: LiveData<TeamEntity> =
        Transformations.switchMap(favoriteTeamId) { id: String ->
            liveData(context = viewModelScope.coroutineContext + Dispatchers.IO) {
